...
<section id="container" class="container">
        ...
        <div class="custom-control custom-radio custom-control-inline">
            <input type="radio" id="customRadioInline2" name="customRadioInline1" value="2" class="custom-control-input" checked>
        ...
        <div style="margin-bottom:10px; color: #495057;">Profile Image</div>
	        <div class="image-upload flex">
		            <div id="input_container" class="col-sm" style="padding: 0px">
		                ...
		                <input id="file-input" class="profileImg_input" name="upFile" type="file" />
		                <div class="delBtn-container col-sm" style="padding-bottom: 10px; margin-left: 17px;"></div>
		            </div>
				</div>
            <input type="text" class="form-control" name="mName" placeholder="이름" required>
            ...
            <input class="form-control" type="date" value="" id="mBDay" required>
                ...
                <div class="image-upload flex">
                    <div id="input_container" class="col-sm">
                        <label id="label1" for="file-input1">
                            <img class="memberImg" id="memberImg_1" style="width: 120px; height: 160px; margin-right: 5px;"
                                src="${path }/resources/images/addImage.png" /><br>
                        </label>
                    ...
                    <div id="input_container" class="col-sm">
                        <label id="label2" for="file-input2">
                            <img class="memberImg" id="memberImg_2" style="width: 120px; height: 160px; margin-right: 5px;"
                                src="${path }/resources/images/addImage.png" /><br>
                        </label>
                    ...
                    <div id="input_container" class="col-sm">
                        <label id="label3" for="file-input3">
                            <img class="memberImg" id="memberImg_3" style="width: 120px; height: 160px; margin-right: 5px;"
                                src="${path }/resources/images/addImage.png" /><br>
                        </label>
                    ...
                    <div id="input_container" class="col-sm">
                        <label id="label4" for="file-input4">
                            <img class="memberImg" id="memberImg_4" style="width: 120px; height: 160px; margin-right: 5px;"
                                src="${path }/resources/images/addImage.png" /><br>
                        </label>
                    ...
                    <div id="input_container" class="col-sm">
                        <label id="label5" for="file-input5">
                            <img class="memberImg" id="memberImg_5" style="width: 120px; height: 160px; margin-right: 5px;"
                                src="${path }/resources/images/addImage.png" /><br>
                        </label>
                    ...
                    <div id="input_container" class="col-sm">
                        <label id="label6" for="file-input6">
                            <img class="memberImg" id="memberImg_6" style="width: 120px; height: 160px; margin-right: 5px;"
                                src="${path }/resources/images/addImage.png" /><br>
                        </label>
	...
	<form action="${path }/member/partyPlannerEnrollEnd.do" method="post" onsubmit="return validate();"  enctype="multipart/form-data" >
		<div id="partyPlannerEnroll-container" style="display: none;">
            ...
            <div id="userId-container">
                <input type="text" class="form-control" name="ppUserId" placeholder="아이디(4글자이상)" id="ppUserId" value='<c:out value="${member.MUserId }"></c:out>' required>
                <span class="guide ok">이 아이디는 사용이 가능합니다.</span>
                <span class="guide error">이 아이디는 사용할 수 없습니다.</span>
            </div>
            ...
            <div class="input-group">
                <input type="email" class="form-control" placeholder="이메일" name="ppEmail" id="ppEmail" value='<c:out value="${member.MEmail }"></c:out>' required readonly>
                <span class="guide ok">사용가능한 이메일입니다.</span>
	            <span class="guide error">이미 가입이 된 이메일입니다.</span>
                <div class="input-group-append">
                    <button class="btn btn-outline-secondary" type="button">인증하기</button>
            ...
            <input type="text" class="form-control" name="ppFacebook" placeholder="Facebook" required>
            <input type="text" class="form-control" name="ppInstagram" placeholder="Instagram" required>
            <input type="text" class="form-control" name="ppTwitter" placeholder="Twitter" required>
            <div class="form-check-inline form-check col" style="display: block;">
                <div style="margin-bottom: 10px; color: #495057;">
                    Music Genre :
                </div>
