...
<section id="container" class="container">
	...
	<form action="${path }/member/memberEnrollEnd.do" method="post" style="margin-block-end: 0px;" 
        ...
        <div style="margin-bottom:10px; color: #495057;">Profile Image</div>
            ...
            <input type="text" class="form-control" name="mName" id="mName" placeholder="이름" value='<c:out value="${member.MName }"></c:out>' required>
            <div id="userId-container">
                <input type="text" class="form-control" name="mUserId" placeholder="아이디(4글자이상)" id="mUserId" value='<c:out value="${member.MUserId }"></c:out>' required>
			...
			<input class="form-control" type="date" value="" name="mBDay" id="birthDate" required>
            <input type="tel" class="form-control" name="mPhone" placeholder="전화번호(- 제외)" required>
            <div class="input-group">
                <input type="email" class="form-control" placeholder="이메일" name="mEmail" id="mEmail" value='<c:out value="${member.MEmail }"></c:out>' required readonly>
            ...
            <select class="form-control" name="mGender" value='<c:out value="${member.MGender }"></c:out>' required>
